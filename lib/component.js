 ...
 *     return {
 *      'some-attr': {type: 'string', description: 'Some attribute'}
 *     }
 *   }
 *
 *   get config() {
...
class Component extends WebComponent {
  ...
  connectedCallback() {
    ...
    Object.keys(this.constructor.attrsSchema).forEach(attr => this._updateAttrs(attr));
   ...
   * @prop {string} type - type of the attribute, default is 'string'

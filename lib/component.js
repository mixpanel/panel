...
class Component extends WebComponent {
  ...
  _syncParams() {
    ...
    for (const param of Object.keys(paramTypes)) {
      ...
      this.params[param] = paramSchemaObj.default;
  ...
  _setParams(params) {
    for (const param in params) {
      ...
      if (this._paramTypes[param].shouldUpdate(oldParam, newParam)) {
        ...
        this.params.$params[param] = newParam;
        this.enqueueUpdate();
      }
    }
  }
  ...
  _updateStore(stateUpdate, options = {}) {
    ...
    if (!this.initialized) {
      ...
      this.runHook(`preUpdate`, updateOptions, stateUpdate, this.params);
      if (cascadeFromRoot) {
        this.$panelRoot.runHook(`preUpdate`, rootOptions, stateUpdate, this.params);
      }
      ...
      if (cascadeFromRoot) {
        this.$panelRoot.runHook(`postUpdate`, rootOptions, stateUpdate, this.params);
      }
    }
  }
